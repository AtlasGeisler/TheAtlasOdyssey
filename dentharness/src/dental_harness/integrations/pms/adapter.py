...
Implement this Protocol and the harness runs on your backend with no changes
elsewhere. Open Dental, Dentrix, Eaglesoft, a SQL view, or a flat-file export
are all just additional implementations.
"""
...
class PMSAdapter(Protocol):
    ...
    def find_patients(self, query: str) -> Sequence[Patient]:
        """Search patients by name, phone, or email. May return empty."""
        ...
